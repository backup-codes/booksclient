...
import { GetToEditLeadAtCap, UpdateLeadsAtCap } from "../../../config/routeApi/cap";
import { toastError, toastSuccess } from "../../../helpers/helpers";


const CaptainUpdateLead = () => {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await GetToEditLeadAtCap(leadId);
  ...
  const handleLeadsSubmit = async (data) => {
    try {
      const response = await UpdateLeadsAtCap(leadId, data);
      if (response.data.success) {
...
export default CaptainUpdateLead;
