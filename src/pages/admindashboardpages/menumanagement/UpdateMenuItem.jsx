...
const UpdateNewMenuItem = () => {
  ...
  const onFinish = async (data) => {
    ...
    if (plateform === "Restaurant") {
      ...
      response = await UpdateOnlineAggregatorPrices({
        ...data,
        plateform,
        itemId,
      });
              ...
              <div className="form-input-row" style={{ marginTop: "2px" }}>
                <div className="form-input">
                  ...
                  <Form.Item
                    name="Cuisine"
                    rules={[
                      { required: true, message: "Missing Cuisine Name" },
                    ]}
                  >
                    <Select
                ...
                <div className="form-input">
                  ...
                  <Form.Item
                    name="subCuisine"
                    rules={[
                      { required: true, message: "Missing Sub-Cuisine Name" },
                    ]}
                  >
                    <Select
                      // disabled={plateform!=="Restaurant"}
              ...
              <div className="form-input-row">
                <div className="form-input-full">
                  ...
                  <Form.Item
                    name="actualPrice"
                    rules={[
                      { required: true, message: "Missing Actual Price" },
                    ]}
                  >
                ...
                <div className="form-input-full">
                  ...
                  <Form.Item
                    name="discountPrice"
                    rules={[
                      { required: true, message: "Missing Discount Price" },
                    ]}
                  >
