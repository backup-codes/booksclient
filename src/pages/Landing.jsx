    ...
    <Wrapper>
      ...
      <section className="landing-page">
        <Container className="banner">
          <h1>
            ...
            <span>a comprehensive accounting system</span> for businesses that
            are growing
          </h1>
      ...
      <section>
        <div className="subcontent right-subcontent">
          ...
          <img
            className="right-subcontent-img"
            src={landingData[0].img}
            alt=""
          />
        </div>
        ...
        <div className="subcontent">
          ...
          <img
            className="left-subcontent-img"
            src={landingData[1].img}
            alt=""
          />
        </div>
