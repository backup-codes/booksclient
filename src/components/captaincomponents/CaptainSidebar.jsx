...
// component imports 
import captainSidebarLinks from "../../utils/CaptainSidebarLinksData";
...
const CaptainSidebar = ({ openSidebarToggle, openSidebar }) => {
  ...
  return (
    ...
    >
      <div className="sidebar-content" style={{ width: "98%", height: "100%" }}>
        ...
        <div className='sidebar-data' style={{ margin: "20px 10px 0px 10px" }}>

          {/* map function for the sidebar links start  */}
          <div>
            {captainSidebarLinks.map((item, index) => {
